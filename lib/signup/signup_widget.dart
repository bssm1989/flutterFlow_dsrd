                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.asset(
                                      'assets/images/415188203_1348171542342726_6047184719058758123_n.jpg',
                                      width: 120.0,
                                      height: 60.0,
                                  ...
                                  Padding(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.asset(
                                        'assets/images/415018437_230923866722669_139696461129208155_n.png',
                                        width: 120.0,
                                        height: 80.0,
                                        fit: BoxFit.fitHeight,
                                      ),
                                  ...
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/Logo_RGB_HEX_ThaiHealth_2022_Logo_TH_2Colors.webp',
                                      width: 90.0,
                                      height: 70.0,
                                      fit: BoxFit.fitHeight,
                                    ),
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'f7t5hwdo' /* ยินดีต้อนรับ สู่ระบบ DSRD */,
                                ),
                                style:
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'al4wwlys' /* กรุณากรอกข้อมูลเข้าสู่ระบบ */,
                                  ),
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText: FFLocalizations.of(context)
                                              .getText(
                                            'tg506xxo' /* User ( ภาษาอังกฤษ 6-8 ตัว) */,
                                          ),
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .bodySmall,
                                  ...
                                  children: [
                                    Expanded(
                                      child: FutureBuilder<ApiCallResponse>(
                                        future:
                                            GetDropDownTambonUserCall.call(),
                                        builder: (context, snapshot) {
                                          ...
                                          final dropDownGetDropDownTambonUserResponse =
                                              snapshot.data!;
                                          return FlutterFlowDropDown<String>(
                                            ...
                                            options: (getJsonField(
                                              dropDownGetDropDownTambonUserResponse
                                                  .jsonBody,
                                              r'''$..tambon''',
                                              true,
                                            ) as List)
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          _model.apiResulttna =
                                            ...
                                            telephone: _model
                                                .emailAddressController5.text,
                                            tambon: _model.dropDownValue,
                                          );
                                          if ((_model.apiResulttna?.succeeded ??
                                              true)) {
