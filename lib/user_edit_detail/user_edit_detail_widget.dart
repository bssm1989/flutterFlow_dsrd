...
import 'user_edit_detail_model.dart';
export 'user_edit_detail_model.dart';

class UserEditDetailWidget extends StatefulWidget {
...
class _UserEditDetailWidgetState extends State<UserEditDetailWidget>
  ...
  late UserEditDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserEditDetailModel());
